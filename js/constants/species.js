...
export const SPECIES = {
  ...
  goumang:{name:'句芒',icon:'🌿',elem:'grass',baseStats:{hp:70,atk:55,def:60,spd:65},
    evoChain:['草芽精','藤灵','句芒神使'],skillPool:{basic:['vinewhip','tackle','guard'],mid:['overgrowth','ironwall'],high:['verdant']},desc:'木神句芒，主春与生'},
  bo:{name:'驳',icon:'🐴',elem:'grass',baseStats:{hp:65,atk:80,def:55,spd:50},
  ...
  // ===== 岩系 Rock (2) =====
  yueyu:{name:'猰貐',icon:'🪨',elem:'rock',baseStats:{hp:100,atk:50,def:85,spd:15},
    evoChain:['岩兽','铁甲猰貐','山岳猰貐'],skillPool:{basic:['rockthrow','guard','slam'],mid:['boulder','ironwall'],high:['avalanche']},desc:'山中巨兽，其皮如岩石'},
  xingtian:{name:'刑天',icon:'⛰️',elem:'rock',baseStats:{hp:85,atk:75,def:70,spd:20},
  ...
  // ===== 神圣系 Holy (2) =====
  baize:{name:'白泽',icon:'✨',elem:'holy',baseStats:{hp:80,atk:45,def:65,spd:55},
  ...
  yingzhao:{name:'英招',icon:'🦄',elem:'holy',baseStats:{hp:70,atk:55,def:70,spd:55},
  ...
  // ===== 龙系 Dragon (3) =====
  yinglong:{name:'应龙',icon:'🐲',elem:'dragon',baseStats:{hp:80,atk:80,def:65,spd:55},
  ...
  zhuyinlong:{name:'烛阴龙',icon:'🌑',elem:'dragon',baseStats:{hp:70,atk:90,def:50,spd:55},
  ...
  chilong:{name:'螭龙',icon:'🐊',elem:'dragon',baseStats:{hp:75,atk:65,def:65,spd:60},
  ...
  // ===== 飞行系 Flying (2) =====
  kunpeng:{name:'鲲鹏',icon:'🦋',elem:'flying',baseStats:{hp:70,atk:55,def:50,spd:90},
    evoChain:['小鲲','化鹏','逍遥鲲鹏'],skillPool:{basic:['gust','watergun','heal'],mid:['hurricane','aquaring'],high:['skyascend','allheal']},desc:'北冥有鱼其名为鲲，化而为鹏'},
  jingwei:{name:'精卫',icon:'🐤',elem:'flying',baseStats:{hp:60,atk:70,def:50,spd:75},
  ...
  // ===== 格斗系 Fight (1) =====
  chiyou:{name:'蚩尤',icon:'👊',elem:'fight',baseStats:{hp:75,atk:90,def:60,spd:35},
    evoChain:['铜首兽','蚩尤战将','魔神蚩尤'],skillPool:{basic:['ironpunch','slam','guard'],mid:['smash','ironwall'],high:['heavenbreak','avalanche']},desc:'铜头铁额，兽身人语'},

  // ===== 水/火 双属性 (1) =====
  jiuying:{name:'九婴',icon:'🌊',elem:'water',baseStats:{hp:85,atk:75,def:45,spd:45},
